...
export async function POST(request: NextRequest) {
  try {
    console.log('=== Terms Complete API Called ===');
    ...
    if (typeof terms_agreed !== 'boolean' || 
      ...
      console.log('Invalid field types - returning 400');
      return NextResponse.json(
    ...
    if (!terms_agreed || !voice_agreed || !copyright_agreed) {
      console.log('Required terms not agreed - returning 400');
      return NextResponse.json(
    ...
    console.log('Calling complete_terms_agreement function...');
    ...
    if (data && data.success) {
      ...
      console.log('Function returned failure - data:', data);
      return NextResponse.json(
